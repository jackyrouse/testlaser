...
void
MapBuilderBridge::HandlerSubmapQuery(::cartographer::mapping::SubmapId &submapid, MySubmapResponse &mysubmapresponse)
{
    cartographer::mapping::proto::SubmapQuery::Response response_proto;
