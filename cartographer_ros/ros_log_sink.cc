...
void
ScopedRosLogSink::send(const ::google::LogSeverity severity,
                       ...
                       const size_t message_len)
{
    ...
    switch (severity)
    {
        case ::google::GLOG_INFO:std::cout << message_string << std::endl;
            break;

        case ::google::GLOG_WARNING:std::cout << message_string << std::endl;
            break;

        case ::google::GLOG_ERROR:std::cout << message_string << std::endl;
            break;

        case ::google::GLOG_FATAL:std::cout << message_string << std::endl;
            will_die_ = true;
            break;
    }
}
