...
void
CheckTrajectoryOptions(const TrajectoryOptions &options)
{
    ...
    ::cartographer::common::LuaParameterDictionary *lua_parameter_dictionary)
{
    ...
    *pose.mutable_relative_pose() =
    ...
    pose.set_timestamp(
        ...
        : cartographer::common::ToUniversal(FromRos(tv)));
    return pose;
}

bool
FromRosMessage(const cartographer_ros_msgs::TrajectoryOptions &msg,
               TrajectoryOptions *options)
{
